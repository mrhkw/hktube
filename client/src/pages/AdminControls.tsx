...
import { AlertTriangle, BarChart3, Ban, Bell, Database, FileVideo, Flag, Gavel, Globe2, KeyRound, LockKeyhole, Megaphone, Palette, Search, Settings2, ShieldCheck, UserCog, Users, WalletCards, Wrench } from "lucide-react";
...
const groups = [
  ...
  { title: "Badges & identity", items: [
    ["Subscriber badges", "100 · 1K · 10K · 100K · 1M · 10M Golden milestone system", "/admin", ShieldCheck, "live"],
    ["Verified badge palette", "12 approved colors for owner verification previews", "/admin", Palette, "live"],
    ["Badge policy", "Keep verification distinct from subscriber milestones", "/help", ShieldCheck, "live"],
  ]},
