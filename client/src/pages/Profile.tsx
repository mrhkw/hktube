...
export default function Profile() {
  ...
  async function shareChannel() {
    ...
    try {
      if (navigator.share) await navigator.share({ title: channel?.displayName || "My HkTube channel", url });
