...
function Router() {
  return <Suspense fallback={<RouteFallback />}><Switch>
    ...
    <Route path="/profile" component={Profile} /><Route path="/channel/:handle" component={PublicChannel} /><Route path="/auth" component={Auth} /><Route path="/watch/:id" component={WatchVideo} /><Route path="/search" component={SearchResults} /><Route path="/upload" component={Upload} /><Route path="/menu" component={Menu} /><Route path="/settings" component={Settings} /><Route path="/studio/settings" component={Settings} /><Route path="/settings/ads" component={AdSettings} /><Route path="/wallet" component={Wallet} />
...
export default function App() {
  return <ErrorBoundary><ThemeProvider defaultTheme="light" switchable><TooltipProvider><AdSenseLoader /><Toaster /><Router /><InstallAppPrompt /></TooltipProvider></ThemeProvider></ErrorBoundary>;
}
