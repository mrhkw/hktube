...
createRoot(document.getElementById("root")!).render(<trpc.Provider client={trpcClient} queryClient={queryClient}><QueryClientProvider client={queryClient}><ThemeManager /><LanguageRuntime /><AccountBootstrap /><MobileDockPolish /><App /><ConsentBanner /></QueryClientProvider></trpc.Provider>);
